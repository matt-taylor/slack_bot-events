...
module SlackBot
  module Events
    class Configuration
      ...
      add_composer :message_middleware, allowed: Middleware::Chain, default: Middleware::Chain.new
      add_composer :open_middleware, allowed: Middleware::Chain, default: Middleware::Chain.new
      add_composer :close_middleware, allowed: Middleware::Chain, default: Middleware::Chain.new
